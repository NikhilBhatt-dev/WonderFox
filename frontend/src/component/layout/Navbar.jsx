...
const Navbar = () => {
  ...
  return (
    ...
    //   {/* Navbar Background */}
    //   {/* <div className="w-full border border-[#f3dce1] bg-[#f8e8ea] px-3 py-3 shadow-[0_18px_40px_rgba(15,23,42,0.08)] sm:px-5"> */}
    //   <div className="w-full rounded-b-[26px] border border-[#f3e6cf] bg-[#fff4dc] px-3 py-3 shadow-[0_18px_40px_rgba(15,23,42,0.08)] sm:px-5">
    //     <nav className="flex w-full items-center justify-between rounded-[24px] border border-white/80 bg-white/90 px-4 py-3 shadow-sm backdrop-blur-xl sm:px-5">
    ...
    //     {/* Mobile Navigation */}
    //     {isOpen && (
    //       <div className="mx-auto mt-3 rounded-[22px] border border-white/80 bg-white/80 p-5 shadow-lg backdrop-blur-xl md:hidden">
